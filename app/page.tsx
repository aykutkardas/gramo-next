...
export default function Home() {
  ...
  return (
    <>
      <Navbar setKeyDialog={setKeyDialog} />
            ...
            <div className="space-y-6">
              <div className="space-y-4">
                <div className="relative">
                  ...
                  <div className="absolute bottom-4 right-4 flex items-center space-x-2">
                    <select
                      value={model}
                      onChange={(e) => setModel(e.target.value as OutputStyle)}
                      className="h-9 max-w-36 truncate rounded-md border bg-background px-3 text-sm focus:outline-none focus:ring-2 focus:ring-primary/50 hover:border-primary/50 transition-colors duration-200"
                      disabled={isLoading}
                    >
              ...
              {analysis && (
                <div className="space-y-8 animate-in fade-in-50 slide-in-from-bottom-4 duration-700">
                  ...
                  <GoalAchievement
                    goalAchievement={analysis.goal_achievement}
                  />
                </div>
              )}
            </div>
